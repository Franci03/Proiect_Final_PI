    ...
    else
    {
        ...
        else
        {
            ...
            try {
                ...
                // Recipients
                $mailer->setFrom('formularcontact1@gmail.com', 'Bibliophile Boutique'); // Replace with your "From" address and name
...
<body>
    ...
    <div class="form-container">
        ...
        <form action="" method="post">
            <h3>Înregistrare</h3>
            <input type="text" name="name" placeholder="introduceți numele" required class="box">
            ...
            <input type="password" name="cpassword" placeholder="confirmă parola" required class="box">

            <select name="user_type" id="" class="box">
                <option value="user">user</option>
                <option value="admin">admin</option>
            </select>
            <input type="submit" name="submit" value="înregistrare" class="btn">
            <p>Ai deja cont? <a href="login.php">Conectare</a></p>
        </form>
    </div>
